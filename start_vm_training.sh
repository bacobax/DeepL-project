...
HPARAMS_CONFS=("base_kl_adv_no_kl_8_ctx_randomCluster" "base_no_kl_adv_no_kl_8_ctx_randomCluster" "all_adv_8_ctx_randomCluster")  # Add your .yaml config names without extension
DEBUG="true"
